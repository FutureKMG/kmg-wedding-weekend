...
export const MORNING_SCHEDULE_SOURCE: MorningScheduleEntry[] = [
  { time: '8:30 AM', service: 'Hair', name: 'Nina Sennott', artist: 'Maddie' },
  { time: '8:30 AM', service: 'Makeup', name: 'Katie Margraf', artist: 'Holly' },
  { time: '9:00 AM', service: 'Hair', name: 'McKenna Magriples', artist: 'Maddie' },
  { time: '9:15 AM', service: 'Makeup', name: 'Nina Sennott', artist: 'Holly' },
  { time: '9:30 AM', service: 'Hair', name: 'Alissa Murphy', artist: 'Maddie' },
  { time: '9:30 AM', service: 'Hair', name: 'Katie Margraf', artist: 'Ayla' },
  { time: '10:00 AM', service: 'Makeup', name: 'Nina Sennott', artist: 'Maddie' },
  { time: '10:00 AM', service: 'Makeup', name: 'McKenna Magriples', artist: 'Holly' },
  { time: '10:15 AM', service: 'Hair', name: 'Nina Sennott', artist: 'Ayla' },
  { time: '10:45 AM', service: 'Makeup', name: 'McKenna Magriples', artist: 'Maddie' },
  { time: '10:45 AM', service: 'Hair', name: 'McKenna Magriples', artist: 'Ayla' },
  { time: '10:45 AM', service: 'Makeup', name: 'Alissa Murphy', artist: 'Holly' },
  { time: '11:15 AM', service: 'Hair', name: 'Alissa Murphy', artist: 'Ayla' },
  { time: '11:30 AM', service: 'Makeup', name: 'Alissa Murphy', artist: 'Maddie' },
  { time: '11:30 AM', service: 'Makeup', name: 'Carley Maleri', artist: 'Holly' },
  { time: '11:45 AM', service: 'Hair', name: 'Fatima Asis', artist: 'Ayla' },
  { time: '12:15 PM', service: 'Junior Hair', name: 'Ainsley Lang', artist: 'Ayla' },
  { time: '12:15 PM', service: 'Makeup', name: 'Ekaterina Scorcia', artist: 'Holly' },
  { time: '12:15 PM', service: 'Bride Makeup', name: 'Kara Margraf', artist: 'Maddie' },
  { time: '12:45 PM', service: 'Hair', name: 'Heather Margraf', artist: 'Ayla' },
  { time: '1:00 PM', service: 'Makeup', name: 'Heather Margraf', artist: 'Holly' },
  ...
  { time: '1:45 PM', service: 'Touchups', name: 'All', artist: 'Holly' },
  { time: '2:15 PM', service: 'Finish', name: 'All', artist: 'Maddie' },
  { time: '2:15 PM', service: 'Finish', name: 'All', artist: 'Ayla' },
  { time: '2:15 PM', service: 'Finish', name: 'All', artist: 'Holly' },
]
